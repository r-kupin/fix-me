...
public class EventConfig {
    ...
    @Bean
    public Consumer<FluxSink<InputEvent<StocksStateMessage>>>
    stockStateUpdateEventPublisher(
    ...
    @Bean
    public Consumer<FluxSink<InputEvent<TradeResponse>>>
    tradeResponseEventPublisher(
            @Qualifier("eventPublisherExecutor")
            Executor executor) {
        return new InputEventPublisher<>(executor);
    }
